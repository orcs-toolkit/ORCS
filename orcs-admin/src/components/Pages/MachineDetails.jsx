...
import Circular1 from "../charts/circular1";
    ...
    <Fragment>
      <div className="row">
        <div className="col-xl-6 mb-4">
          <div className="card">
            <div className="card-header align-items-center flex-wrap border-0 pb-0">
              <h4 className="fs-20 text-black mb-2 mr-3">Visitor Graph</h4>
            </div>
        ...
        <div className="col-xl-6">
          <div className="row">
            <div className="col-xl-4 col-xxl-6 col-lg-4 col-sm-6 my-2">
              <div className="card">
            ...
            <div className="card-header border-0 pb-0">
              ...
              <Dropdown className="dropdown float-right custom-dropdown mb-0">
                ...
                <Dropdown.Menu className="dropdown-menu dropdown-menu-right">
                  <Dropdown.Item className="dropdown-item" to="/statistics">
                    Details
                  </Dropdown.Item>
                  <Dropdown.Item
              ...
              <div className="row">
                <div className="col-sm-4  pl-5">
                  <div className="d-flex align-items-center my-4">
                    ...
                    <div>
                      <p className="fs-14 font-w500 mb-1">Following</p>
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <div>
                      <p className="fs-14 font-w500 mb-1">Followers</p>
                      <span className="fs-20 text-black font-w600">
                        8,334 Person
                      </span>
                    </div>
                ...
                <div className="col-sm-8">
                  <div className="d-inline-block network-chart mb-2 relative donut-chart-sale mr-4">
                    <Circular2
                      backgroundColor="#374C98"
                      backgroundColor2="#FFAB2D"
                      value="23"
                    />
                    <small className="text-black fs-30">23%</small>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card-body">
              <div className="row sp10">
                <div className="col-xl-3 col-xxl-6 col-md-3 col-6 mb-4 text-center">
                  <div className="d-inline-block ml-auto mr-auto mb-2 relative donut-chart-sale">
                    <Circular1
                      ...
                      cutoutPercentage="70"
                    />
                    <small className="text-black fs-20">66%</small>
                  </div>
                  <h6 className="fs-18 text-black font-w600 mb-0">Engineer</h6>
                  <span className="fs-14">5,050 Vacancy</span>
                </div>
                <div className="col-xl-3 col-xxl-6 col-md-3 col-6 mb-4 text-center">
                  <div className="d-inline-block ml-auto mr-auto mb-2 relative donut-chart-sale mr-4">
                    <Circular1
                      backgroundColor="#40189D"
                      height="120"
                      width="120"
                      ...
                      cutoutPercentage="70"
                    />
                    <small className="text-black fs-20">31%</small>
                  </div>
                  <h6 className="fs-18 text-black font-w600 mb-0">Designer</h6>
                ...
                <div className="col-xl-3 col-xxl-6 col-md-3 col-6 mb-4 text-center">
                  <div className="d-inline-block ml-auto mr-auto mb-2 relative donut-chart-sale">
                    <Circular1
                      ...
                      cutoutPercentage="70"
                    />
                    <small className="text-black fs-20">75%</small>
                  </div>
                  <h6 className="fs-18 text-black font-w600 mb-0">Manager</h6>
                ...
                <div className="col-xl-3 col-xxl-6 col-md-3 col-6 mb-4 text-center">
                  <div className="d-inline-block ml-auto mr-auto mb-2 relative donut-chart-sale">
                    <Circular1
                      ...
                      cutoutPercentage="70"
                    />
                    <small className="text-black fs-20">62%</small>
                  </div>
